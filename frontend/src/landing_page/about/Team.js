    ...
    <div className="container">
      ...
      <div className="row text-muted align-items-center" style={{ lineHeight: "1.8", fontSize: "16px" }}>
        ...
        <div className="col-lg-6 col-md-12 text-center p-5">
          ...
          />
          <h5 className="mt-4">Wonder Women</h5>
        ...
        <div className="col-lg-6 col-md-12 p-5">
          <p>
            Wonder Women bootstrapped and founded Zerodha in 2010 to overcome the hurdles he faced during his decade-long stint as a trader.
