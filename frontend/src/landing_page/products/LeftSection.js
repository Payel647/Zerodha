        ...
        <div className="row align-items-center">
            ...
            <div className="col-md-6 col-sm-12 p-4 text-center text-md-start">
                ...
                <div className="mt-3 d-flex justify-content-center justify-content-md-start gap-3">
                    <a href={googlePlay}><img src="media/googlePlayBadge.svg" alt="" style={{ maxWidth: "120px" }} /></a>
                    <a href={appStore}><img src="media/appstoreBadge.svg" alt="" style={{ maxWidth: "120px" }} /></a>
                </div>
            </div>
        </div>
       </div>
